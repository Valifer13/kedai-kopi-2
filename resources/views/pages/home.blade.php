                    ...
                    <div class="row aligns-item-center">
                        <div class="col-lg-6 offset-lg-3">
                            <div class="text-center">
                                ...
                                <p class="lead wow fadeInUp">Dari hidangan kopi lezat hingga suasana yang menyenangkan, pembukaan besar kami menjanjikan pengalaman bersantai yang tak terlupakan.</p>
                    ...
                    <div class="row g-4 text-center">
                        <div class="col-lg-4 wow fadeInRight">
                            <div class="p-4 jarallax" data-jarallax data-speed="0.1">
                                ...
                                <div class="spacer-single"></div>
                                <h3>Rasa Aromatik</h3>
                                <p>Kaya, mengundang, dan sangat menggoda, rasa aromatik kopi adalah perjalanan sensorik yang dimulai dengan menciumnya pertama kali. </p>
                        ...
                        <div class="col-lg-4 wow fadeInRight" data-wow-delay=".1s">
                            <div class="p-4 jarallax" data-jarallax data-speed="0.1">
                                ...
                                <p>Kami juga menyediakan beberapa makanan ringan yang cocok dinikmati dengan secangkir kopi anda. Sekaligus menemani masa bersantai anda.</p>
                                <a href="#" class="btn-line">Baca Lebih</a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 wow fadeInRight" data-wow-delay=".2s">
                            <div class="p-4 jarallax" data-jarallax data-speed="0.1">
                                ...
                                <p>Mengubah kafe kami yang nyaman menjadi tujuan pesta utama, tempat teman-teman berkumpul, tawa mengalir, dan kenangan tercipta.</p>
                                <a href="#" class="btn-line">Baca Lebih</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row g-4">
                        <div class="col-lg-6 offset-lg-3 text-center">
                            ...
                            <p class="lead wow fadeInUp">Pelanggan senang, hati pun senang! Bergabunglah dengan jajaran pelanggan kami yang puas dan nikmati secangkir kopi nikmat yang belum pernah ada sebelumnya.</p>
                        </div>
                        ...
                        <div class="col-lg-4 wow fadeInRight" data-wow-delay=".2s">
                            <div class="de-review-app h-100">
                                ...
                                <div class="d-testi">
                                    Saya bukan hanya datang untuk kopinya, tetapi juga untuk suasana dan pelayanannya. Setiap kunjungan ke Cafe ini serasa pulang ke rumah, tempat yang penuh kehangatan dan rasa autentik.
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 text-center mb-sm-20 wow fadeInRight" data-wow-delay="0s">
                            <div class="position-relative overflow-hidden mb20">
                                <img src="03_images/team/{{ $item['image'] }}" class="img-fluid position-relative z-index-1000" alt="">
                            </div>
                    ...
                    <div class="row-fluid">
                        <div class="col-lg-6 offset-lg-6">
                            <div class="padding80">
                                ...
                                <blockquote>
                                    Sebagai seorang profesional yang sibuk, saya mengandalkan kopi pagi untuk mengawali hari. Rasa yang kaya, lembut, dan aroma surgawi tidak pernah gagal untuk menyegarkan saya dan membuat saya siap menghadapi apa pun yang terjadi hari ini. Seperti sepotong kecil surga dalam secangkir!
                ...
                <div class="container">
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-9 text-lg-start text-sm-center wow fadeIn">
                            <h3><i class="id-color fa fa-phone mr10"></i>Panggil kami sekarang dan dapatkan tawaran spesial!</h3>
                        </div>
